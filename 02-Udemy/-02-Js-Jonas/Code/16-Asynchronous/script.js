...
*/
/////////////////////////////////////////////////////////////////////
//--- Promises and the Fetch API -- Consuming Promises -- Chaining Promises -- Handling Rejected Promises -- Throwing Errors Manually -----------------------
/*
// const request = new XMLHttpRequest();
...
/*
const footballPromise = new Promise(function (resolve, reject) {
  console.log('Football draw is happening');

  setTimeout(() => {
    if (Math.random() >= 0.5) {
      resolve('You WIN 🏆');
    } else {
      reject(new Error('You lost your Cup 😞'));
    }
  }, 2000);
});

footballPromise.then(res => console.log(res)).catch(err => console.error(err));
...
get3Countries('egypt', 'morocco', 'syria');
*/
/////////////////////////////////////////////////////////////////////
...
(async function () {
  const res = await Promise.race([
    ...
    getJSON(`https://restcountries.com/v2/name/tunisia`),
  ]);
  console.log(res[0]);
})();
...
Promise.race([getJSON(`https://restcountries.com/v2/name/iraq`), timeout(5)])
